...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/bootstrap.min.css')}}">
    <!-- animate CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/animate.css')}}">
    <!-- owl carousel CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/owl.carousel.min.css')}}">
    <!-- themify CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/themify-icons.css')}}">
    <!-- flaticon CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/flaticon.css')}}">
    <!-- magnific popup CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/magnific-popup.css')}}">
    <!-- nice select CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/nice-select.css')}}">
    <!-- swiper CSS -->
    <link rel="stylesheet" href="{{asset('medico/css/slick.css')}}">
    <!-- style CSS -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{route('login')}}"> <img src="../assets/images/favicon.png" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                <li class="nav-item active">
                                    <a class="nav-link" href="<?php echo $_SERVER["REQUEST_URI"]; ?>">Home</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-xl-2 col-md-4 col-sm-6 single-footer-widget">
                        <a href="#" class="footer_logo"> <img src="../asset/img/logo.png" alt="#"> </a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="{{asset('medico/js/jquery-1.12.1.min.js')}}"></script>
    <!-- popper js -->
    <script src="{{asset('medico/js/popper.min.js')}}"></script>
    <!-- bootstrap js -->
    <script src="{{asset('medico/js/bootstrap.min.js')}}"></script>
    <!-- owl carousel js -->
    <script src="{{asset('medico/js/owl.carousel.min.js')}}"></script>
    <script src=".{{asset('medico/js/jquery.nice-select.min.js')}}"></script>
    <!-- contact js -->
    <script src="{{asset('medico/js/jquery.ajaxchimp.min.js')}}"></script>
    <script src=".{{asset('medico/js/jquery.form.js')}}"></script>
    <script src="{{asset('medico/js/jquery.validate.min.js')}}"></script>
    <script src="{{asset('medico/js/mail-script.js')}}"></script>
    <script src="{{asset('medico/js/contact.js')}}"></script>
    <!-- custom js -->
    <script src="{{asset('medico/js/custom.js')}}"></script>
</body>
